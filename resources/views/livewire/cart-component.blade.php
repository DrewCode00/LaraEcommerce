				...
				@if (Cart::instance('cart')->count() > 0)
						...
						@if (Cart::instance('cart')->count() > 0)
							...
							@foreach(Cart::instance('cart')->content() as $item)
								<li class="pr-cart-item">
									...
									<div class="price-field produtc-price"><p class="price">AED{{$item->model->regular_price}}</p></div>
									<div class="quantity">
									...
									<div class="price-field sub-total"><p class="price">AED{{$item->subtotal}}</p></div>
									<div class="delete">
					...
					<div class="summary">
						<div class="order-summary">
							...
							<p class="summary-info"><span class="title">Subtotal</span><b class="index">AED{{Cart::instance('cart')->subtotal()}}</b></p>
							@if(Session::has('coupon'))
								...
								<p class="summary-info"><span class="title">Subtotal with discount</span><b class="index">AED{{number_format($subtotalAfterDiscount,2)}}</b></p>
								<p class="summary-info"><span class="title">Tax ({{config('cart.tax')}}%)</span><b class="index">AED{{number_format($taxAfterDiscount,2)}}</b></p>
								<p class="summary-info total-info "><span class="title">Total</span><b class="index">AED{{number_format($totalAfterDiscount,2)}}</b></p>
							@else
								<p class="summary-info"><span class="title">Tax</span><b class="index">AED{{Cart::instance('cart')->tax()}}</b></p>
								<p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
								<p class="summary-info total-info "><span class="title">Total</span><b class="index">AED{{Cart::instance('cart')->total()}}</b></p>
							@endif
						</div>
