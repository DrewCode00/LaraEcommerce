<main id="main">
		<div class="container">
			...
			<!--On Sale Products-->
            {{--}}
			@if($sproducts->count() > 0 && $sale->satus == 1 && $sale->sale_date > Carbon\Carbon::now() )
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box">On Sale</h3>
				<div class="wrap-countdown mercado-countdown" data-expire="{{ Carbon\Carbon::parse($sale->sale_date)->format(Y/m/d ) }} "></div>
			...
			<div class="wrap-show-advance-info-box style-1 "><!-- has-countdown (belongs to div class if with timer)-->
				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true"
                 ...
                 @foreach ($lproducts as $lproduct)
                    <div class="product product-style-2 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <div class="wrap-price"><span class="product-price">AED {{$lproduct->regular_price}}</span></div>
                        </div>
                    </div>
                @endforeach
									...
									@foreach($c_products as $c_product)
										<div class="product product-style-2 equal-elem ">
											...
											<div class="product-info">
												...
												<div class="wrap-price"><span class="product-price">AED {{$c_product->regular_price}}</span></div>
											</div>
										</div>
									@endforeach
								</div>
